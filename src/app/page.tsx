    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-20">
          ...
          >
            Soundwave<br />
            <span className="text-[#D4AF37] italic text-4xl md:text-6xl font-light tracking-normal">School of Music</span>
          </motion.h1>
          ...
          >
            An elite conservatory offering world-class instruction in fingerstyle guitar and classical piano.
          </motion.p>
      ...
      <section className="py-24 bg-[#0a0f1d]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-serif font-bold text-white mb-4">Our Philosophy</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              >
                ...
                <h3 className="text-2xl font-serif font-semibold text-white mb-4">{feature.title}</h3>
      ...
      <section className="py-24 bg-[#0F172A] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-serif font-bold text-white mb-4">Student Voices</h2>
            <div className="w-24 h-1 bg-[#D4AF37] mx-auto rounded-full"></div>
          </div>
            ...
            {[
              ...
              >
                <div className="flex gap-1 mb-6">
                  {[...Array(5)].map((_, j) => (
                    <Star key={j} className="h-5 w-5 text-[#D4AF37] fill-[#D4AF37]" />
                  ))}
                </div>
                ...
                <div>
                  <h4 className="font-serif font-bold text-white text-xl">{testimonial.author}</h4>
                  <p className="text-[#D4AF37] text-sm mt-1">{testimonial.role}</p>
                </div>
              </motion.div>
            ))}
          </div>
