...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("Login feature will be fully active once Supabase keys are configured!");
  };
  ...
  return (
    <div className="bg-[#0F172A] min-h-screen flex items-center justify-center pt-20 pb-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-0 w-96 h-96 bg-[#D4AF37]/5 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-[#1E293B]/50 rounded-full blur-3xl"></div>
      ...
      >
        <div className="bg-[#0a0f1d] border border-[#1E293B] py-10 px-8 shadow-2xl sm:rounded-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#94A3B8] text-sm">Log in to your student portal.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="block text-sm font-medium text-[#E2E8F0]" htmlFor="password">
                  Password
                </label>
                <a href="#" className="text-sm font-medium text-[#D4AF37] hover:text-[#B89600]">
                  Forgot password?
                </a>
              </div>
          ...
          <div className="mt-8 text-center border-t border-[#1E293B] pt-6">
            <p className="text-sm text-[#94A3B8]">
              ...
              <Link href="/register" className="font-medium text-[#D4AF37] hover:text-[#B89600] transition-colors">
                Book a Trial
              </Link>
            </p>
          </div>
